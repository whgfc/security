...
import com.example.security.UserDetailsRepository;
...
public class UserDetailsConfiguration {
    ...
    public UserDetailsRepository userDetailsRepository() {
        ...
        UserDetails felordcn = User.withUsername("user").password("{noop}12345").authorities(AuthorityUtils.NO_AUTHORITIES).build();
